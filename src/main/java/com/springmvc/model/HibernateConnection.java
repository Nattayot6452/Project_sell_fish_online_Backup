...
public class HibernateConnection {
    ...
    static String url = "jdbc:mysql://mysql:3306/fishdatabase?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&useSSL=false&allowPublicKeyRetrieval=true"; 
